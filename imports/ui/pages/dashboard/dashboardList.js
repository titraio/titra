...
Template.dashboardList.events({
  'change .js-customer-checkbox': function (e, tpl) {
  ...
  'change .js-project-checkbox': function (e, tpl) {
    const { value } = e.target
  ...
  'click .js-clear-filters': function (e, tpl) {
    e.preventDefault()
  ...
  'click #togglePassword': function (event, template) {
  ...
  'click .js-save-dashboard': function (event, template) {
    event.preventDefault()
